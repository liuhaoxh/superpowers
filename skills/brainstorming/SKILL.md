...
- any turn where the user explicitly says "只给最终结论 / 直接回答 / 不要过程 / 不要解释内部过程"

## The Process

**Understanding the idea:**
- Check out the current project state first (files, docs, recent commits)
- But if the task is review / cleanup / verification / hard-stop confirmation rather than open-ended design, do not use this skill; exit and use the narrower workflow instead
